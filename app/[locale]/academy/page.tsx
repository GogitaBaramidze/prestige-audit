...
export default function TeachingCenterPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="relative z-20 -mt-24 bg-white rounded-t-[60px] md:rounded-t-[80px] shadow-[0_-20px_50px_-20px_rgba(0,0,0,0.1)] animate-section-rise overflow-hidden">
