...
function ConsultingServiceCard({
  ...
  return (
    <motion.div
      className={`group relative rounded-[28px]  h-[280px] md:h-auto  bg-gradient-to-br ${cyan.bg} border border-transparent ${cyan.border} p-6 shadow-sm hover:shadow-xl ${cyan.hoverShadow} transition-all duration-500 overflow-hidden`}
...
export default function BusinessConsultingPage() {
  ...
  const consultingTeam = TEAM_MEMBERS.filter((m) =>
    m.departments.includes("business-consulting"),
  );
    ...
    <div className="min-h-screen font-sans">
      ...
      <div className="bg-[#f3f5f4]">
        ...
        <section className="px-6 lg:px-12 pb-16">
          <motion.div
            className="w-full relative overflow-hidden rounded-[36px] bg-[#041224] p-10 md:p-12 text-center"
