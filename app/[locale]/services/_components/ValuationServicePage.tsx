...
function ValuationServiceCard({
  ...
  return (
    <motion.div
      className={`group relative rounded-[28px]  h-[280px] md:h-auto   bg-gradient-to-br ${amber.bg} border border-transparent ${amber.border} p-6 shadow-sm hover:shadow-xl ${amber.hoverShadow} transition-all duration-500 overflow-hidden`}
...
export default function ValuationServicesPage() {
  ...
  const valuationTeam = TEAM_MEMBERS.filter((m) =>
    m.departments.includes("valuation-services"),
  );
    ...
    <div className="min-h-screen font-sans">
      ...
      <div className="bg-[#f3f5f4]">
        ...
        <section className="px-6 lg:px-12 pb-16">
          <motion.div
            className="w-full relative overflow-hidden rounded-[36px] bg-[#1c1207] p-10 md:p-12 text-center"
