  ...
  return (
    ...
    >
      <img
        ...
        loading="eager"
      />
      <div className="absolute inset-0 bg-gradient-to-t from-[#1c1207]/90 via-[#1c1207]/20 to-transparent" />
      <div className="absolute bottom-0 left-0 right-0 p-5 translate-y-2 group-hover:translate-y-0 transition-transform duration-400">
        ...
        <div className="mt-3 overflow-hidden max-h-0 group-hover:max-h-16 transition-all duration-400 ease-in-out">
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-full border border-white/40 px-4 py-1.5 text-xs font-semibold text-white transition-colors duration-300 hover:bg-white hover:text-[#1c1207]"
          >
            {t("teamViewProfile")}
    ...
    <div className="min-h-screen bg-[#f3f5f4] font-sans">
        ...
        >
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              >
                {t("heroHeading")}{" "}
                <span className="text-transparent bg-clip-text py-1 bg-gradient-to-r from-amber-300 to-orange-200">
              ...
              <motion.p
                className="text-amber-100/70 text-base leading-[1.85] mb-10 max-w-lg"
                initial={{ opacity: 0, y: 16 }}
                animate={{ opacity: 1, y: 0 }}
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-12 py-12 md:py-16">
        <div className="grid lg:grid-cols-2 gap-10 items-start">
          ...
          >
            <div
              className={`relative rounded-[28px] bg-gradient-to-br ${amber.bg} border ${amber.lightBorder} p-6 shadow-sm overflow-hidden`}
            >
      ...
      <section id="services" className="bg-[#f3f5f4] py-12 md:py-16">
      ...
      <section className="bg-[#f3f5f4] py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            <Link
              href="/team?team=valuation"
              className={`inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r ${amber.lightBg} border ${amber.lightBorder} ${amber.text} font-semibold text-sm transition-all duration-300 shadow-sm hover:shadow-lg ${amber.hoverShadow} hover:border-transparent hover:scale-[1.02] group/link relative overflow-hidden`}
            >
              <span
                className={`absolute inset-0 rounded-full bg-gradient-to-r ${amber.gradient} opacity-0 group-hover/link:opacity-100 transition-opacity duration-300`}
              />
              <span className="relative z-10 group-hover/link:text-white transition-colors duration-300">
                {t("teamViewAll")}
              </span>
              <ArrowRight
                className={`relative z-10 w-4 h-4 ${amber.text} group-hover/link:text-white transition-all duration-300 group-hover/link:translate-x-1`}
              />
            </Link>
          </motion.div>
        </div>
      ...
      <section className="px-6 lg:px-12 pb-16">
        <motion.div
          className="max-w-7xl mx-auto relative overflow-hidden rounded-[36px] bg-[#1c1207] p-10 md:p-12 text-center"
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-amber-100/60 max-w-md mx-auto mb-6 text-sm leading-relaxed">
              {t("ctaBody")}
            </p>
