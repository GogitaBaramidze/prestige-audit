  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-7xl relative z-10 px-6">
        <motion.div
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md text-blue-200 text-md md:text-basefont-bold uppercase tracking-widest mb-8"
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.2 }}
        >
          <GraduationCap size={14} /> {t("academySectionLabel")}
        </motion.div>
      </div>
    </motion.section>
  );
